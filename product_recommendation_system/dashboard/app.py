...
try:
    ...
    df = pd.read_csv('/Users/piyushpatel/Documents/data analytics/product_recommendation_system/data/processed/human_readable_data.csv')
except FileNotFoundError:
    # Fall back to the file in the main data analytics directory
    df = pd.read_csv('/Users/piyushpatel/Documents/data analytics/data/processed/human_readable_data.csv')
